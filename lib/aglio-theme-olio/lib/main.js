...
const getParameters = function (actionElement, resourceElement) {
	...
	for (const hrefVariable of hrefVariables) {
		...
		const parameter = {
			...
			description: (hrefVariable.meta != null && hrefVariable.meta.description != null ? hrefVariable.meta.description.content : undefined) || '',
			type: (hrefVariable.meta != null && hrefVariable.meta.title != null ? hrefVariable.meta.title.content : undefined),
...
const decorate = function (api, md, slugCache, verbose) {
	...
	api.description = md.render(getApiDescription(api));
	if (api.description) {
	...
	if (defaultResourceGroup) {
		api.resourceGroups.unshift(defaultResourceGroup);
	}
};
...
exports.render = function (input, options, done) {
	...
	if (options.themePermalinkSymbol == null) {
		options.themePermalinkSymbol = '¶';
	}
	...
	const md = markdownIt({
		...
		permalinkSymbol: options.themePermalinkSymbol
	}
